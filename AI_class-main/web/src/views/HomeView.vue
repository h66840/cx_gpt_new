    ...
    <div class="hero-section">
      ...
      <div class="hero-content">
        ...
        <div class="description">
          <p class="subtitle">Agent驱动的视觉推理</p>
          <p class="features">
            <span>📚 灵活知识库</span>
            <span>🕸️ 创新视觉推理</span>
            <span>🤖 多模型助手支持</span>
        ...
        <button class="start-button" @click="goToChat">开启实验之旅</button>
      </div>
    </div>

    <div class="preview-section">
      <div class="preview-container">
        <img src="/brain.png" alt="系统预览" />
        <div class="preview-overlay">
          <div class="overlay-content">
            <h3>强大的视觉推理</h3>
            <p>模拟脑思考，提供更准确、更具解释性的回答</p>
          </div>
        </div>
      </div>
    </div>
