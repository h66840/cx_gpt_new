  ...
  <div class="user-management">
    <div class="page-header">
      <div class="title-section">
        <h2>用户管理</h2>
        <p class="description">用户管理，请谨慎操作，一旦删除用户，该用户将无法登录。</p>
      </div>
      <a-button type="primary" @click="showAddUserModal" class="add-user-btn">
        <template #icon>
          <PlusOutlined />
        </template>
        添加用户
    ...
    >
      <a-form layout="vertical">
        ...
        <a-form-item label="角色">
          <a-select v-model:value="userManagement.form.role" class="role-select">
