...
import ExperimentExecutionTypeB from '@/views/ExperimentExecutionTypeB.vue'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: ':id/run', // 路径包含实验 ID
          name: 'ExperimentExecution', // 给路由命名，方便跳转
          component: () => import('../views/ExperimentExecution.vue'),
          props: true, // 启用props传参映射到新的组件
          meta: { keepAlive: false, requiresAuth: true, requiresAdmin: false }
        },
        {
          path: '/experiment/typeb/execute/:id',
          name: 'ExperimentExecutionTypeB',
          component: ExperimentExecutionTypeB
        }
      ]
    },
    {
